        ...
        <div class="">
            <el-carousel trigger="click" class="zouma">
              <el-carousel-item v-for="(img,index) in imgList" :key="index">
                <a v-for="(item,index) in sports" :key="index" :href="item.link"><img :src="img.url"  :alt="item.title"></a>
              </el-carousel-item>
            </el-carousel>
        </div>
      </el-col>
...
export default {
  ...
  data () {
    return {
      // msg: store.state.tech
      tech: [],
      sports: [],
      imgList:[
        {url:require('@/img/one.png')},
        {url:require('@/img/two.png')},
        {url:require('@/img/three.png')},
        {url:require('@/img/four.png')}
      ],
      loading: true,
      isShow: true
